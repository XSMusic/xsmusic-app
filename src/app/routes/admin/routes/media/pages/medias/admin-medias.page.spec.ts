...
import { AdminMediasPage } from './admin-medias.page';

describe('AdminMediasPage', () => {
  let component: AdminMediasPage;
  let fixture: ComponentFixture<AdminMediasPage>;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [AdminMediasPage, NgxPermissionsAllowStubDirective],
      imports: [
        SharedModule,
    ...
    fixture = TestBed.createComponent(AdminMediasPage);
